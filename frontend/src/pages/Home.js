    ...
    <Box bgColor="black" height={{ md: "100vh" }}>
      ...
      >
        <Box marginRight={{ base: 0, md: 50 }}>
          <Text fontSize="3xl" textAlign="center" color="lightblue" mb="3">
            Not familiar with PMP?
          </Text>
          <Text textAlign="center" color="ivory" fontSize="2xl">
            PMP is a minimalistic and intutive project tracking application,
            which focuses on simplifying user experinece with seamless
            navigation and simple UI.
            <br />
            If you never used PMP before, we urge you to try posting some of
            your projects.
            <br />
            <Button color="black" bgColor="lightblue" mt="5">
              <Link to="/register">Register</Link>
            </Button>
          </Text>
        </Box>
        <Box mt={{ base: 10, md: 0 }}>
          <Text textAlign="center" fontSize="3xl" color="lightblue" mb="3">
            Already have an account?
          </Text>
          <Text textAlign="center" color="ivory" fontSize="2xl">
            We are super happy that you've created an account with us, feel free
            to post your projects here and track them on a regular basis. 
            <br />
